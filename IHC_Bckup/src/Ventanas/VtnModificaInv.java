...
public class VtnModificaInv extends javax.swing.JDialog
{
    ...
    public VtnModificaInv(String registro, String nombre, String placas, String color, String marca, String tamaño)
    {
        initComponents();
        vtn = this;
        lblNoRegistro.setText(registro);
        jTNombre.setText(nombre);
        jTPlacas.setText(placas);
        jTColor.setText(color);
        jTMarca.setText(marca);
        jCTamaño.setSelectedItem(tamaño);
        jBSalir.setBackground(new Color(0, 0, 0, 0));
    }

    public VtnModificaInv()
    {
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Modificar registro invitado");
        ...
        jLabel14.setToolTipText("Ventana para modificar los datos de un Invitado");
        ...
        btnGdInvitado.setText("Modificar datos");
    ...
    {//GEN-HEADEREND:event_btnGdInvitadoActionPerformed
        ...
        {
            //Modificando en la BD
            arr[0] = jTNombre.getText();
            arr[1] = jTPlacas.getText();
            arr[2] = jTColor.getText();
            arr[3] = jTMarca.getText();
            arr[4] = jCTamaño.getSelectedItem().toString();
            ConfirmacionModificarV mod = new ConfirmacionModificarV(null, true,2);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnModificaInv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VtnModificaInv().setVisible(true);
            }
        });
    }
